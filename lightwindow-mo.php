...
Description: 通用代码（t,w,h可选择性填写）：[lw t="显示的连接名" w="宽" h="高"]文件地址[/lw]，下载页面代码（可直接[dlw][/dlw]）：[dlw did="自定义值" t="要显示的链接文字"]下载链接列表[/dlw]，自定义HTML页面代码：[hlw hid="自定义值" w="宽" h="高" t="要显示的链接文字"]html代码[/hlw]，视频代码：[vlw v1="地址1" t1="视频1名" v2="地址2" t2="视频2名" v3="" t3="" v4="" t4="" v5="" t5="" w="宽" h="高"]视频列表总标题[/vlw]目前只支持swf，且一行区域只能设置5个，超过5个再用次代码，或者修改插件文件。标明有宽高的，必须设置。
Author: mo1984 
...
<div align="center" style="width:500px;height:150px;margin:0 0 0 20px;">
<div>
	<p style="line-height:200%;margin-top:20px"><strong>免责申明</strong></p>
...
<p style="line-height:200%">如无法下载，请与老莫联系，联系方式请见网站侧边栏</p></div>
</div>
</div>
';
}
...
<div id="divqvod"><script type="text/javascript">// <![CDATA[
 var qvodurl="'.$v.'";var qwidth=500; var qheight=400; // ]]></script><script src="'.get_bloginfo('wpurl').'/wp-content/plugins/lightwindow-mo/javascript/qvod.js" type="text/javascript"></script></div><div style="clear:both"></div>
</div>
';
}
...
"pid" => '',"w" => '',"h" => '',"t"=> '',"pic"=> ''
	...
	return '<div id="sh">'.$t.' 弹窗查看</div>
<div id="moshow"><p><a href="#'.$pid.'play" class="lightwindow page-options" params="lightwindow_width='.$w.',lightwindow_height='.$h.'" title="'.$t.'">点击查看…'.$t.'</a><br>Tip:点击链接会弹出【'.$t.'】播放窗口,请在网页加载完成之后点击！</p></div>
<div id="'.$pid.'play" style="display:none">
<video  
    src="'.$content.'" 
    poster="'.$pic.'" 
    id="'.$pid.'"   
...
<script type="text/javascript"> 
    jwplayer("'.$pid.'").setup({ 
        flashplayer: "'.get_bloginfo('wpurl').'/wp-content/plugins/lightwindow-mo/player.swf" 
    }); 
</script>  </div>
';
}

add_shortcode('player','videoplayer');
...
<script type="text/javascript" src="'.get_bloginfo('wpurl').'/wp-content/plugins/lightwindow-mo/javascript/jwplayer.js"></script>
<script type="text/javascript" src="'.get_bloginfo('wpurl').'/wp-content/plugins/lightwindow-mo/javascript/swfobject.js"></script>
	');
}
